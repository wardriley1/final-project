...
export default function About() {
    ...
    //         <h3>Reviews</h3>
    //         <p>When you click on a <Link href="/allreviews">REVIEWS</Link>, itll bring you to its Individual page. Here, you can edit the review *if you are the one who posted it*, and add a comment to the review. You can also edit the comment if youre the one who posted it.</p>
    //         <h3>My Profile</h3>
