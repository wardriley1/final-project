...
export default function AboutContent() {
  ...
  return (
    ...
    <div className="mb-about-container">
            ...
            <h3>Reviews</h3>
            <p>When you click on <Link href="/allreviews">REVIEWS</Link>, itll bring you to a page with all current reviews from all existing users. Here, you can sort by review score, and access the full review by clicking on the READ FULL REVIEW button.</p>
            <h3>Profiles</h3>
            <p>To view current user profiles, you can navigate to <Link href='/profiles'>PROFILES</Link>. Here you can view existing profiles, with their username and bio. Depending on if youre signed up or not, user profiles will be clickable, sending you to their pofile page with a list of their existing album reviews. A count of the number of reviews on our app will be displayed at the bottom of the page. </p>
            <h3>My Profile</h3>
